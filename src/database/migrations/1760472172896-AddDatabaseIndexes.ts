...
export class AddDatabaseIndexes1760472172896 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE INDEX "IDX_233485dfe62fd31abbf1f7f69d" ON "authors" ("createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6c64b3df09e6774438aeca7e0b" ON "authors" ("name") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bf20a3d4cdb6c6218a4e7c59ae" ON "books" ("createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c7760822496bddacef8771f44b" ON "books" ("publicationYear", "genre") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_b680b98bcf359141ab1877de68" ON "user" ("status", "role") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b680b98bcf359141ab1877de68"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c7760822496bddacef8771f44b"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_bf20a3d4cdb6c6218a4e7c59ae"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6c64b3df09e6774438aeca7e0b"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_233485dfe62fd31abbf1f7f69d"`,
    );
  }
}
